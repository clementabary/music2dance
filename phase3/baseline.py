...
import datetime
import numpy as np
from phase3.models.default import SequenceGenerator
...
for epoch in range(num_epochs):
    ...
    for (real, _, audio, _, _) in train_loader:
        ...
        real = real.view(batch_size, stick_length,
    ...
    if (epoch + 1) % 500 == 0:
        print("Iteration: {} L1 train : {} L1 val : {}".format(
            total_iterations, err_l1, e_val_loss))
