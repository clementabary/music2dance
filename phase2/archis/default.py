...
class SequenceGenerator(nn.Module):
    def __init__(self, input_size, latent_size, size, output_size,
                 n_blocks, n_cells=1, device="cpu"):
...
class SequenceDiscriminator(nn.Module):
    def __init__(self, channels_in, channels_h, seqlen,
                 init_ker=7, n_blocks=1, device="cpu"):
